                    ...
                    <React.Fragment key={index}>
                      ...
                      <div>
                        ...
                        <div key={index} style={{ marginBottom: '20px' }}>
                          ...
                          {data.map((val, index) => {
                            const dataForVal =
                              productDataMapping[val as keyof typeof productDataMapping];

                            // Check if there is data for the current val before rendering the Accordion
                            if (dataForVal && dataForVal.length > 0) {
                              return (
                                <div key={index} style={{ marginBottom: '20px' }}>
                                  <Accordion
                                    title={val as keyof typeof productDataMapping}
                              ...
                              // If there is no data for WIP, don't render the Accordion
                              return null;
                            }
                          })}
                        </div>
